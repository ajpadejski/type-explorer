...
import { FontInput, loadGoogleFont } from "./FontInput.jsx";
import SurfaceStudio from "./surface/SurfaceStudio.jsx";
...
function TypeExplorer({ onSurface }) {
      ...
      <div style={{ background: "var(--color-background-primary)", borderBottom: "0.5px solid var(--color-border-tertiary)", padding: "16px 20px 0" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, flexWrap: "wrap" }}>
          ...
          <div style={{ marginLeft: "auto", display: "flex", gap: 10, alignItems: "center" }}>
            ...
            <button
              onClick={onSurface}
              style={{ fontSize: 11, padding: "4px 12px", letterSpacing: "0.04em" }}
            >
              Surface Studio →
            </button>
          </div>
...
export default function App() {
  ...
  if (page === "surface") return <SurfaceStudio onBack={() => setPage("explorer")} />;
  return <TypeExplorer onSurface={() => setPage("surface")} />;
}
